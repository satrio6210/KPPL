...
<head>
    ...
    <title>Tekumamba, Tebengin Bang!</title>
...
<body style="background:url('<?php echo base_url();?>img/cat.jpg')">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
                        <a href="<?php echo base_url();?>index.php/dashboard/login">Login</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">Tekumamba, Tebengin Bang!</p>
                ...
                <div class = "container">
				<div class="wrapper">
					<form action="<?php echo base_url().'index.php/dashboard/login'; ?>" method="post" name="Login_Form" class="form-signin">       
					<h3 class="form-signin-heading">Welcome Back Please Sign In!</h3>
					<hr class="colorgraph"><br>
			  
					<input type="text" class="form-control" name="Username" placeholder="Username" required="" maxlength="40"/>
