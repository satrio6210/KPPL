...
<head>
	...
	<link href="http://localhost/KPPL/assets/css/styleprofile.css" rel='stylesheet' type='text/css'/>
	<link href="//fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet">
	<link href="//fonts.googleapis.com/css?family=Roboto+Condensed:300,400" rel="stylesheet">
	<link href="http://localhost/KPPL/assets/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
...
<body>
	<h1>Accessible Profile Widget</h1>
		<div class="main-agileits">
		<div class="right-wthree">
				<img src="<?php echo base_url() . $Ufoto; ?>" alt="image" />
			...
			<ul class="address">
													<li>
														<ul class="address-text">
															<li><b>PHONE </b></li>
															<li>: +00 111 444 3333</li>
														</ul>
													</li>
													<li>
														<ul class="address-text">
															<li><b>ADDRESS </b></li>
															<li>: 756 4th block,USA.</li>
														</ul>
													</li>
													<li>
														<ul class="address-text">
													...
													<li>
														<ul class="address-text">
															<li><b>WEBSITE </b></li>
															<li><a href="http://w3layouts.com">: www.example.com</a></li>
														</ul>
													</li>
												</ul>
				
				<div class="button">
					<a href="#small-dialog" class="play-icon popup-with-zoom-anim">Click to play video</a>
				</div>
	...
	<footer>
		<p class="agileinfo"> &copy; 2017 Accessible Profile Widget. All Rights Reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
	</footer>
</body>
</html>