  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
        ...
        <h1>Welcome to Tekumamba</h1>
        <h2>Yuk mas mbak! <span class="rotating">tebeng, nebeng, dengan mudah!</span></h2>
        <div class="actions">
          <a href="<?php echo base_url('index.php/Login');?>" class="btn-get-started">Login/Register</a>
          <a href="#about" class="btn-services">About Tekumamba</a>
        </div>
      </div>
    </div>
  </section>
